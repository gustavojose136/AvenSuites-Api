...
namespace AvenSuitesApi.Infrastructure.Migrations
{
    ...
    [Migration("20251031182117_AddGuestUserRelationship")]
    partial class AddGuestUserRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.IpmCredentials", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            HotelId = new Guid("7a326969-3bf6-40d9-96dc-1aecef585000"),
                            Password = "t/1l71mSIkD7NClI3jpg5ntlWtlWjHDb/DT8l6WUync=",
                            SerieNfse = "1",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Administrator",
                            PasswordHash = "$argon2i$v=19$m=4096,t=2,p=2$ldooqsR00iYpvFt+YkUehg$0V98em3kB/VyPEBxhIw7LYTbk4tUzkSii9N80eFCKYY"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Gustavo",
                            PasswordHash = "$argon2i$v=19$m=4096,t=2,p=2$i9lLxfYPsWLlb0+hViN87A$TiNuwkwgjRUAxQ4qlsH3qxlAtUQTSmbhaNWVIllyBuE",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });
