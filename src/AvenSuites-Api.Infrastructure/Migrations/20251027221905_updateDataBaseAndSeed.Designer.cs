...
namespace AvenSuitesApi.Infrastructure.Migrations
{
    ...
    [Migration("20251027221905_updateDataBaseAndSeed")]
    partial class updateDataBaseAndSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5998a0fd-161b-438e-9269-f9cc60135ddf"),
                            ...
                            CountryCode = "BR",
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 756, DateTimeKind.Utc).AddTicks(9324),
                            ...
                            UpdatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 756, DateTimeKind.Utc).AddTicks(9486)
                        });
                });
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2a6a15e2-3f27-42ae-aff0-742c93f1e2e9"),
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 656, DateTimeKind.Utc).AddTicks(3916),
                        ...
                        new
                        {
                            Id = new Guid("5e5da1e0-a1c3-4bf6-ad5b-c9a39e813a15"),
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 656, DateTimeKind.Utc).AddTicks(4268),
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("22c95694-1c4a-4928-9a9a-c707c0dd91b6"),
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 812, DateTimeKind.Utc).AddTicks(2465),
                            Floor = "1",
                            HotelId = new Guid("5998a0fd-161b-438e-9269-f9cc60135ddf"),
                            RoomNumber = "101",
                            RoomTypeId = new Guid("7d6d65e9-b3b9-4686-a0e9-543653a37f02"),
                            Status = "ACTIVE",
                            UpdatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 812, DateTimeKind.Utc).AddTicks(2606)
                        },
                        new
                        {
                            Id = new Guid("ace5ee94-2c9f-4836-8a53-a9e0032ef3e4"),
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 812, DateTimeKind.Utc).AddTicks(2741),
                            Floor = "1",
                            HotelId = new Guid("5998a0fd-161b-438e-9269-f9cc60135ddf"),
                            RoomNumber = "102",
                            RoomTypeId = new Guid("7d6d65e9-b3b9-4686-a0e9-543653a37f02"),
                            Status = "ACTIVE",
                            UpdatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 812, DateTimeKind.Utc).AddTicks(2741)
                        },
                        new
                        {
                            Id = new Guid("5195185c-43b0-44cf-b50b-2d634ef03236"),
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 812, DateTimeKind.Utc).AddTicks(2743),
                            Floor = "1",
                            HotelId = new Guid("5998a0fd-161b-438e-9269-f9cc60135ddf"),
                            RoomNumber = "103",
                            RoomTypeId = new Guid("7d6d65e9-b3b9-4686-a0e9-543653a37f02"),
                            Status = "ACTIVE",
                            UpdatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 812, DateTimeKind.Utc).AddTicks(2743)
                        });
                });
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.RoomType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7d6d65e9-b3b9-4686-a0e9-543653a37f02"),
                            Active = true,
                            BasePrice = 150.00m,
                            CapacityAdults = (short)2,
                            CapacityChildren = (short)1,
                            Code = "STD",
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 811, DateTimeKind.Utc).AddTicks(7949),
                            Description = "Quarto padrão com cama de casal",
                            HotelId = new Guid("5998a0fd-161b-438e-9269-f9cc60135ddf"),
                            Name = "Standard",
                            UpdatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 811, DateTimeKind.Utc).AddTicks(8259)
                        });
                });
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9c6a5460-c861-4ab0-8eab-8b7dabc10de6"),
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 756, DateTimeKind.Utc).AddTicks(882),
                            Email = "admin@avensuites.com",
                            IsActive = true,
                            Name = "Administrator",
                            PasswordHash = "$argon2i$v=19$m=4096,t=2,p=2$2Nnvz7sT6+Utx3T000EV2w$jkGc6uVVc6yxhtJtq+bOJPZyGZ/AUWxZuumRnv6f+Kk"
                        },
                        new
                        {
                            Id = new Guid("ab86dc1f-22ce-4e6e-9554-900d71bb3c15"),
                            CreatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 810, DateTimeKind.Utc).AddTicks(7579),
                            Email = "gjose2980@gmail.com",
                            IsActive = true,
                            Name = "Gustavo",
                            PasswordHash = "$argon2i$v=19$m=4096,t=2,p=2$T+RnPWOnYmq724IYYxCj+g$V5C5MwcLnnrpnSTQaAg9YFUErSNvwgiLlqUP6tmNPiE",
                            UpdatedAt = new DateTime(2025, 10, 27, 22, 19, 2, 810, DateTimeKind.Utc).AddTicks(7580)
                        });
                });
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("9c6a5460-c861-4ab0-8eab-8b7dabc10de6"),
                            RoleId = new Guid("2a6a15e2-3f27-42ae-aff0-742c93f1e2e9"),
                            AssignedAt = new DateTime(2025, 10, 27, 22, 19, 2, 756, DateTimeKind.Utc).AddTicks(3763)
                        },
                        new
                        {
                            UserId = new Guid("ab86dc1f-22ce-4e6e-9554-900d71bb3c15"),
                            RoleId = new Guid("2a6a15e2-3f27-42ae-aff0-742c93f1e2e9"),
                            AssignedAt = new DateTime(2025, 10, 27, 22, 19, 2, 811, DateTimeKind.Utc).AddTicks(349)
                        });
                });
