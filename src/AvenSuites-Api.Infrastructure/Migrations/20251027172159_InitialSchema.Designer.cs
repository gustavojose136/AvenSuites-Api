...
namespace AvenSuitesApi.Infrastructure.Migrations
{
    ...
    [Migration("20251027172159_InitialSchema")]
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4d5fdc8b-8944-4148-9697-61a4b5634b92"),
                            CreatedAt = new DateTime(2025, 10, 27, 17, 21, 57, 605, DateTimeKind.Utc).AddTicks(8885),
                        ...
                        new
                        {
                            Id = new Guid("633eb99e-dd8f-4e8d-a6ff-501b05cb2e55"),
                            CreatedAt = new DateTime(2025, 10, 27, 17, 21, 57, 605, DateTimeKind.Utc).AddTicks(9168),
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6c328a45-384f-4f23-8335-571980d78825"),
                            CreatedAt = new DateTime(2025, 10, 27, 17, 21, 57, 672, DateTimeKind.Utc).AddTicks(8470),
                            Email = "admin@avensuites.com",
                            IsActive = true,
                            Name = "Administrator",
                            PasswordHash = "$argon2i$v=19$m=4096,t=2,p=2$HWRdCt2GqngUDNeHXAV9mg$2/1k9knaNxO5Kv9DEEXMNYgHyqPBWGmKnaZLAx/zXJ8"
                        });
                });
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("6c328a45-384f-4f23-8335-571980d78825"),
                            RoleId = new Guid("4d5fdc8b-8944-4148-9697-61a4b5634b92"),
                            AssignedAt = new DateTime(2025, 10, 27, 17, 21, 57, 672, DateTimeKind.Utc).AddTicks(9834)
                        });
                });
