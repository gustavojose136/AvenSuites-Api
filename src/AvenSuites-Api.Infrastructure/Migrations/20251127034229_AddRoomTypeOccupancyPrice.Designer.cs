...
namespace AvenSuitesApi.Infrastructure.Migrations
{
    ...
    [Migration("20251127034229_AddRoomTypeOccupancyPrice")]
    partial class AddRoomTypeOccupancyPrice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.IpmCredentials", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            HotelId = new Guid("7a326969-3bf6-40d9-96dc-1aecef585000"),
                            Password = "VceeEdmOAtqGlSiJsimMyunknS2wkbU6lmywwxxngkc=",
                            SerieNfse = "1",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Administrator",
                            PasswordHash = "$argon2i$v=19$m=4096,t=2,p=2$/2cU64A7qOgrahCFG7+QCg$Ww6XdZ/tNPi8gHaoaRP2bZgFqLs8WjaDe1khEMH9b0E"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Name = "Gustavo",
                            PasswordHash = "$argon2i$v=19$m=4096,t=2,p=2$H4vcToe4vSBYMFI9Pzg/7A$X0hjAGYo0ATuNsZfkO+g+i5gaQBnvieX6Lj5PtcXC1E",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.Guest", b =>
                {
                    ...
                    b.HasOne("AvenSuitesApi.Domain.Entities.User", null)
                        .WithOne("Guest")
                        .HasForeignKey("AvenSuitesApi.Domain.Entities.Guest", "UserId1");
            ...
            modelBuilder.Entity("AvenSuitesApi.Domain.Entities.GuestPii", b =>
                {
                    b.HasOne("AvenSuitesApi.Domain.Entities.Guest", "Guest")
                        .WithOne("GuestPii")
                        .HasForeignKey("AvenSuitesApi.Domain.Entities.GuestPii", "GuestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
